...
gulp.task('copy:css', function() {
    return gulp.src([
        paths.src.base + '/src/css/style.css',
        paths.src.base + '/src/css/base.css',
        paths.src.base + '/src/scss/config/business_theme_variables.css',
        paths.src.base + '/src/scss/config/consumer_theme_variables.css'
    ])
    .pipe(gulp.dest(paths.dist.base + '/css'))
});
...
gulp.task('copy:js', function() {
    return gulp.src([
        paths.src.base + '/src/js/main.js',
        paths.src.base + '/src/js/jquery-3.1.1.min.js'
    ])
    .pipe(gulp.dest(paths.dist.base + '/js'))
});
